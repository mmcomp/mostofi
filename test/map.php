...
if($dbok){
//----------user_view-------
	$query = "select `LON` `lon`,`LAT` `lat` from `track` where `USER_ID` = 222 and date(regtime) = '2017-11-14' order by ID";
  if($res = $my->query($query)){
    while($r = $res->fetch_assoc()){
			$points[] = array('lon'=>$r['lon'],'lat'=>$r['lat']);
		}
	}
//--------------------------
  $vals = array();
  ...
  <body onload="init();">
    ...
    <ul>
      <li class='has-sub'><a href='#'><span>تغییر مبنای دسته بندی</span></a>
        <ul>
          <li>
						<a href='?selected_base=sh_mantaghe'><span>مناطق سیزدگانه شهرداری</span></a>
					</li>
          <li>
						<a href='?selected_base=manategh'><span>نواحی شهرداری</span></a>
					</li>
          <li>
						<a href='?selected_base=nahiye'><span>نواحی ترافیکی شهرداری</span></a>
					</li>
				</ul>
			</li>
      <li class='has-sub'><a href='#'><span>گزارشات آماری</span></a>
        <ul>
          <li class='has-sub'>
            <a href='?report=stat&variable=job&value=0'><span>پراکندگی مشاغل جامعه آماری</span></a>
            <ul>
              <li>
                <a href='?report=stat&variable=job&value=1'><span>پراکندگی شغل کارمند جامعه آماری</span></a>
              </li>
              <li>
                <a href='?report=stat&variable=job&value=2'><span>پراکندگی شغل آزاد جامعه آماری</span></a>
              </li>
              <li>
                <a href='?report=stat&variable=job&value=3'><span>پراکندگی دانشجو جامعه آماری</span></a>
              </li>
              <li>
                <a href='?report=stat&variable=job&value=4'><span>پراکندگی دانش آموز جامعه آماری</span></a>
              </li>
              <li>
                <a href='?report=stat&variable=job&value=5'><span>پراکندگی خانه دار جامعه آماری</span></a>
              </li>
              <li>
                <a href='?report=stat&variable=job&value=6'><span>پراکندگی بیکار جامعه آماری</span></a>
              </li>
            </ul>
          </li>
          <li class='has-sub'>
            <a href='#'>
              <span>
                پراکندگی جنسیت جامعه آماری
              </span>
            </a>
            <ul>
              <li>
                <a href='?report=stat&variable=GENDER&value=m'><span>پراکندگی مرد جامعه آماری</span></a>
              </li>
              <li>
                <a href='?report=stat&variable=GENDER&value=f'><span>پراکندگی زن جامعه آماری</span></a>
              </li>
            </ul>
          </li>
          <li class='has-sub'>
      ...
      <li class='has-sub'><a href='#'><span>گزارشات تولید و جذب</span></a>
        <ul>
          <li>
            <a href='javascript:loadTolid()'><span>گزارشات تولید</span></a>
          </li>
          <li>
            <a href='javascript:loadJazb()'><span>گزارشات جذب</span></a>
          </li>
        </ul>
      </li>
